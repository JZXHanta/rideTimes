...
gorilla_falls_exploration_trail = dict({
...
expedition_everest_legend_of_the_forbidden_mountain = dict({
...
feathered_friends_in_flight = dict({
...
finding_nemo_the_big_blue_and_beyond = dict({
...
meet_favorite_disney_pals_at_adventurers_outpost = dict({
...
the_animation_experience_at_conservation_station = dict({
...
discovery_island_array = [
    its_tough_to_be_a_bug,
    meet_favorite_disney_pals_at_adventurers_outpost
]

pandora_the_world_of_avatar_array = [
    avatar_flight_of_passage,
    navi_river_journey
]

rafikis_planet_watch_array = [the_animation_experience_at_conservation_station]
...
def pandora_the_world_of_avatar():
